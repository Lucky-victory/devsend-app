...
export default function CampaignsPage() {
  ...
  const handleCreateCampaign = async () => {
    ...
    try {
      const scheduledAt =
        newCampaign.schedule === "schedule" ? Date.now() + 3600000 : undefined; // 1 hour from now
          ...
          >
            ...
            <DialogContent className="sm:max-w-[500px]">
              <DialogHeader>
                ...
                <DialogDescription>
                  Set up your email campaign with a template and audience
                  segment.
                </DialogDescription>
              </DialogHeader>
              <div className="space-y-4 py-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setNewCampaign({ ...newCampaign, templateId: value })
                    }
                  >
                    <SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setNewCampaign({ ...newCampaign, segment: value })
                    }
                  >
                    <SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setNewCampaign({ ...newCampaign, schedule: value })
                    }
                  >
                    <SelectTrigger>
                    ...
                    <div className="grid grid-cols-4 gap-6 text-center">
                      <div>
                        <p className="text-2xl font-bold">
                          {campaign.stats.totalSent.toLocaleString()}
                        </p>
                        <p className="text-xs text-muted-foreground">Sent</p>
                      </div>
                      <div>
                        <p className="text-2xl font-bold">
                          {campaign.stats.totalOpened.toLocaleString()}
                        </p>
                        <p className="text-xs text-muted-foreground">Opened</p>
                      </div>
                      <div>
                        <p className="text-2xl font-bold">
                          {campaign.stats.totalClicked.toLocaleString()}
                        </p>
