    ...
    const compileTemplate = async () => {
      ...
      try {
        ...
        if (validation.isValid) {
          ...
          const compiled = await compileEmailTemplate(templateContent, parsedData)
    ...
    >
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Modify your {template.type} email template</p>
            </div>
          </div>
          <div className="flex items-center space-x-2">
            ...
            <Button variant="outline" asChild>
              <Link href={`/dashboard/email-templates/${params.templateId}/preview`}>
        ...
        <Card className="glassmorphism">
          ...
          <CardContent className="grid gap-4 md:grid-cols-3">
            ...
            <div className="space-y-2">
              ...
              <Select value={templateStatus} onValueChange={(value: "draft" | "published") => setTemplateStatus(value)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-2">
              ...
              <div className="text-sm text-muted-foreground pt-2">{new Date(template.updatedAt).toLocaleString()}</div>
            </div>
          </CardContent>
        </Card>
      </motion.div>
      ...
      {template.type === "code" ? (
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Badge variant={isCompiling ? "secondary" : validationErrors.length > 0 ? "destructive" : "default"}>
                    {isCompiling ? "Compiling..." : validationErrors.length > 0 ? "Errors" : "Ready"}
                  </Badge>
                </div>
              </CardHeader>
              <Separator />
        ...
        <motion.div variants={fadeInUp} className="h-[800px]">
          <VisualEditor templateId={params.templateId} onSave={handleVisualSave} />
        </motion.div>
      )}
    </motion.div>
  )
